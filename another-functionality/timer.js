 ...
 * и считает тебе опять 2400 секунд от 600 секунд теории, хотя, ты уже просидел эти самые 
 * 600 секунд 
 */
 ...
 * -в (Ф) таймер, передается значение amount*4 и сохраняется в переменной которая будет отображаться на экране
 * -после нажатия доступ к теории приостановить?
 */
// -- UI logic
